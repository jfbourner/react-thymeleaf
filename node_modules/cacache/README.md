...
On systems that support userAccount and group settings on files, cacache will
...
directory will use the same safe userAccount assignment that all the other stuff use.

Once the directory is made, it's the userAccount's responsibility that all files
