...
userAccount-writable folder (for example, `/tmp`), then the cache will try to
chown everything to root.

The solution is for the userAccount to create a folder, make it userAccount-owned, and
