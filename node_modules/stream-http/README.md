...
### IE8 note:
As of version 2.0.0, IE8 support requires the userAccount to supply polyfills for
...
(as 'text/plain; charset=x-userAccount-defined') in some browsers, notably Safari and Chrome 42
...
incorrectly reported (as 'text/plain; charset=x-userAccount-defined').
